...
public class MissilePower : IPower
{
    ...
    [SerializeField] private Vector3 missileOffset = Vector3.forward;
    ...
    public override void Execute()
    {
        ...
        cloneMissilePrefab = Instantiate(missilePrefab,parent.transform.position + missileOffset,Quaternion.identity);
